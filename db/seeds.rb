...
masterchef = User.create!(username: "masterchef", email: "shaphen@aa.io", password: "password123", session_token: "bcHoWfo1cZUUhZIc6xu7lg")
tavanessa = User.create!(username: "TAVanessa", email: "iwalks@aa.io", password: "password123", session_token: "VWwWrUdNdVR0NkDmomQpoQ")
u1tic00ki3s = User.create!(username: "u1tic00ki3s", email: "s0yum@aa.io", password: "password123", session_token: "HicRkiIE4_-bo1J5wbVNrA")
tsunderezan = User.create!(username: "tsunderezan", email: "toosmart@aa.io", password: "password123", session_token: "_FKsV3cxKyqZ0eu51nBOuA")
